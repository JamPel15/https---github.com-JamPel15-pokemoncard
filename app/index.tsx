    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <View style={styles.header}>
          ...
          <Text style={styles.hp}>🧠 HP: 86</Text>
        </View>
        ...
        <View style={[styles.typeBadge, { borderColor: "#000" }]}>
          <Text style={[styles.typeText, { color: "#000" }]}>🪨 Teravolt</Text>
        </View>

        <Text style={styles.sectionLabel}>Moves:</Text>
        <Text style={styles.sectionText}>
          Teravolt, Dark Aura, Fairy Aura,  Aura Break
        </Text>

        <Text style={styles.sectionLabel}>Weakness:</Text>
        <Text style={styles.sectionText}>Poison, Ground, Fairy,</Text>
      </View>
